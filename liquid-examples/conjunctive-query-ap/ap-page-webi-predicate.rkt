...
;;    
  (define (webi-predicate-request-form url)
    (let*
      (
        ...
        [the-form
          `(
             (form (@ 
               ...
               (fieldset
                 (legend "Deep Web Search - web interface predicate test")
...
;;
  ...
  ;;
    (define (get-form-query-wi arrival-url)
      (let*(
             [form/query (webi-predicate-request-form arrival-url)]
...
;;
    (define (page-test-webi-predicate the-session-context arrival-url)
      (let*
        (
     ...
     (page-hook "/test/webi-pred" page-test-webi-predicate)
...
;;
  (define (ap-page-webi-predicate-internal-trace)
    (trace
      webi-predicate-request-form
      info-reset
      info-hook
      get-form-query-wi
      parse-query-wi
      ...
      fetch-page-wi
      scrape-wi
      page-test-webi-predicate-body
      filter-webi-pred
      filter-pred-test-0
      filter-pred-test-1
      ))

  (define (ap-page-webi-predicate-internal-untrace)
    (untrace
      webi-predicate-request-form
      info-reset
      info-hook
...
;;
  (provide
    ...
    ap-page-webi-predicate-internal-untrace
    )

  (provide-with-trace "ap-page-webi-predicate"
    page-test-webi-predicate
    )
