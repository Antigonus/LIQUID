      ...
      (let*(
        ...
        (nd-equal?
          ...
          `(ndql0:operand
             ...
             (nd:string
               ((at:source ,(lexer-ql0-name) "test-session" (1 1 0) (6 1 5))
                 (at:lexeme "\"abc\""))))
          )
        ))
        ...
        (nd-equal?
          ...
          `(ndql0:pred
             ...
             (ndql0:operand
               ...
               (nd:symbol
                 ((at:source ,(lexer-ql0-name) "test-session" (9 1 8) (10 1 9))
                   (at:lexeme "c")))))
          )
        ))
          ...
          `(ndql0:conjunction
             ...
             (ndql0:pred
                ...
                (ndql0:operand
                  ...
                  (nd:string
                    ((at:source ,(lexer-ql0-name) "test-session" (5 1 4) (10 1 9))
                      (at:lexeme "\"jim\""))))
                (ndql0:operand
