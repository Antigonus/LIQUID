2553
((3) 0 () 2 ((q lib "liquid/dataplex-lib.rkt") (q lib "liquid/db-lib.rkt")) () (h ! (equal) ((c def c (c (? . 0) q db:find-dataplex)) q (3660 . 4) (3534 . 4)) ((c def c (c (? . 0) q semantic-relation:match)) q (5342 . 8)) ((c def c (c (? . 0) q shape-relation:insert)) q (4473 . 5)) ((c def c (c (? . 1) q db:tables)) q (813 . 3)) ((c def c (c (? . 1) q db:dealloc-number)) q (181 . 3)) ((c def c (c (? . 1) q keyspace:alloc-number)) q (890 . 3)) ((c def c (c (? . 1) q db:delete-table*)) q (589 . 3)) ((c def c (c (? . 1) q table:insert)) q (1192 . 4)) ((c def c (c (? . 0) q db:is-dataplex-name*)) q (3419 . 4)) ((c def c (c (? . 0) q shape-relation:match)) q (4850 . 5)) ((c def c (c (? . 0) q dataplex:delete-shape-relation*)) q (3011 . 5)) ((c def c (c (? . 0) q shape-relation:delete)) q (4650 . 6)) ((c def c (c (? . 1) q table:delete)) q (1079 . 4)) ((c def c (c (? . 1) q db:is-keyspace)) q (680 . 3)) ((c def c (c (? . 0) q dataplex:create-shape-relation)) q (2507 . 8)) ((c def c (c (? . 0) q db:delete-dataplex)) q (4287 . 3)) ((c def c (c (? . 0) q db:create-dataplex*)) q (4141 . 4)) ((c def c (c (? . 0) q db:dataplexes)) q (3227 . 3)) ((c def c (c (? . 0) q dataplex:delete-semantic-relation)) q (2043 . 6)) ((c def c (c (? . 0) q dataplex:delete-semantic-relation*)) q (2273 . 5)) ((c form c (c (? . 1) q with-connection)) q (1606 . 2)) ((c def c (c (? . 1) q db:create-keyspace)) q (243 . 3)) ((c def c (c (? . 1) q table:insert*)) q (1303 . 4)) ((c def c (c (? . 0) q db:is-dataplex*)) q (3894 . 3)) ((c def c (c (? . 0) q db:is-dataplex-name)) q (3312 . 4)) ((c def c (c (? . 0) q db:delete-dataplex*)) q (4377 . 3)) ((c def c (c (? . 1) q db:is-table)) q (748 . 3)) ((c form c (c (? . 1) q as-transaction)) q (0 . 2)) ((c def c (c (? . 0) q db:create-dataplex)) q (4003 . 4)) ((c def c (c (? . 1) q db:delete-table)) q (506 . 3)) ((c def c (c (? . 0) q dataplex:delete-shape-relation)) q (2795 . 5)) ((c def c (c (? . 0) q semantic-relation:insert)) q (5042 . 8)) ((c def c (c (? . 0) q dataplex:create-semantic-relation)) q (1707 . 8)) ((c def c (c (? . 1) q table:match)) q (1422 . 5)) ((c def c (c (? . 1) q db:delete-keyspace)) q (429 . 3)) ((c def c (c (? . 1) q db:dealloc-name)) q (74 . 3)) ((c def c (c (? . 0) q db:is-dataplex)) q (3793 . 3)) ((c def c (c (? . 1) q db:alloc-name)) q (35 . 2)) ((c def c (c (? . 1) q db:create-table)) q (320 . 4)) ((c def c (c (? . 0) q dataplex-lib-init)) q (1666 . 2)) ((c def c (c (? . 1) q keyspace:dealloc-number)) q (972 . 4)) ((c def c (c (? . 1) q db:alloc-number)) q (140 . 2))))
syntax
(as-transaction body ...)
procedure
